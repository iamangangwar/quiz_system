...
CREATE TABLE `academic_ques` (
  ...
  PRIMARY KEY (`QuesID`),
  CONSTRAINT `academic_ques_ibfk_1` FOREIGN KEY (`QuesID`) REFERENCES `question` (`QuesID`)
...
INSERT INTO `academic_ques` VALUES ('q1','CS204'),('q2','CS204'),('q3','CS204'),('q4','CS204'),('q5','CS204');
...
CREATE TABLE `contains` (
  ...
  KEY `fkeyq` (`QuesID`),
  CONSTRAINT `contains_ibfk_1` FOREIGN KEY (`QuesID`) REFERENCES `question` (`QuesID`),
...
INSERT INTO `contains` VALUES ('qz1','q1',10),('qz1','q2',20),('qz1','q3',50),('qz1','q4',80),('qz1','q5',100),('qz2','q10',80),('qz2','q6',20),('qz2','q7',50),('qz2','q8',80),('qz2','q9',100);
...
CREATE TABLE `non_acad_ques` (
  ...
  PRIMARY KEY (`QuesID`),
  CONSTRAINT `non_acad_ques_ibfk_1` FOREIGN KEY (`QuesID`) REFERENCES `question` (`QuesID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `question` VALUES ('q1',1,'A','2022-02-02',1,NULL),('q10',1,'D','2022-02-02',1,NULL),('q11',5,'B','2022-03-24',4,NULL),('q2',2,'B','2022-02-02',2,NULL),('q3',3,'C','2022-02-02',5,NULL),('q4',2,'C','2022-02-02',2,NULL),('q5',1,'D','2022-02-02',1,NULL),('q6',1,'A','2022-02-02',1,NULL),('q7',1,'B','2022-02-02',1,NULL),('q8',1,'C','2022-02-02',2,NULL),('q9',1,'C','2022-02-02',1,NULL);
...
INSERT INTO `quiz` VALUES ('qz1','2022-01-01 13:00:00','2022-01-01 13:30:00',30,'Academic'),('qz2','2022-01-01 12:00:00','2022-01-01 12:30:00',30,'Encore');
...
CREATE TABLE `response` (
  ...
  KEY `fkeyq` (`QuesID`),
  CONSTRAINT `response_ibfk_1` FOREIGN KEY (`StudentID`) REFERENCES `student_name` (`StudentID`),
  CONSTRAINT `response_ibfk_2` FOREIGN KEY (`QuesID`) REFERENCES `question` (`QuesID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `response` VALUES ('10','qz2','q10','B',0),('10','qz2','q6','B',0),('10','qz2','q7','B',1),('10','qz2','q8','B',0),('10','qz2','q9','B',0),('89','qz1','q1','B',0),('89','qz1','q2','B',2),('89','qz1','q3','C',3),('89','qz1','q4','D',0),('89','qz1','q5','D',1);
...
CREATE TABLE `taken_from` (
  ...
  PRIMARY KEY (`QuesID`),
  KEY `fkeyqb` (`qbID`),
  CONSTRAINT `taken_from_ibfk_1` FOREIGN KEY (`qbID`) REFERENCES `question_bank` (`qbID`),
  CONSTRAINT `taken_from_ibfk_2` FOREIGN KEY (`QuesID`) REFERENCES `question` (`QuesID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `taken_from` VALUES ('q1','qb1'),('q2','qb1'),('q3','qb1'),('q4','qb1'),('q5','qb1'),('q10','qb2'),('q6','qb2'),('q7','qb2'),('q8','qb2'),('q9','qb2');
...
-- Dump completed on 2022-04-28 10:47:40
